  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-500 to-blue-700 py-16 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-10">
        ...
        <ul className="list-disc pl-6 text-gray-700 mb-4">
          <li>You are responsible for the accuracy of your profile, resume, and applications.</li>
          <li>You must not upload misleading or fraudulent information.</li>
          <li>You must not impersonate any individual or entity.</li>
          <li>You must follow all applicable laws while using the platform.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 text-gray-700 mb-4">
          ...
          <li>Communicate with recruiters through authorized channels</li>
        </ul>
        ...
        <h2 className="text-2xl font-semibold text-blue-600 mt-8 mb-4">
          4. Communication With Recruiters
        </h2>
        <ul className="list-disc pl-6 text-gray-700 mb-4">
