        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-150/60 overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-50">
                <h2 className="text-md font-extrabold text-slate-900 tracking-tight flex items-center">
                  <i className="fas fa-history mr-2 text-slate-500"></i> Application History
                </h2>
              </div>
              <div className="p-6">
                {applicationHistory && applicationHistory.length > 0 ? (
                  <div className="overflow-x-auto rounded-xl border border-slate-100">
                    <table className="min-w-full divide-y divide-slate-100">
                      <thead className="bg-slate-900">
                        <tr>
                          <th className="px-5 py-3.5 text-left text-[10px] font-bold text-slate-300 uppercase tracking-wider">
                            Type
                          </th>
                          <th className="px-5 py-3.5 text-left text-[10px] font-bold text-slate-300 uppercase tracking-wider">
                            Title
                      ...
                      <tbody className="bg-white divide-y divide-slate-100">
                        {applicationHistory.map((app, index) => (
                          <tr key={index} className="hover:bg-slate-50 transition-colors duration-150">
                            ...
                            <td className="px-5 py-4 whitespace-nowrap text-xs text-slate-700 font-semibold">{app.title}</td>
                            <td className="px-5 py-4 whitespace-nowrap text-xs text-slate-700 font-semibold">{app.company}</td>
                            <td className="px-5 py-4 whitespace-nowrap text-xs text-slate-500 font-semibold">
                              {new Date(app.appliedAt).toLocaleDateString()}
                            </td>
                            <td className="px-5 py-4 whitespace-nowrap">
                              <span
                                className={`px-2.5 py-0.5 inline-flex text-[10px] leading-5 font-bold rounded-lg ${
                                  app.status === 'Pending'
                  ...
                  <div className="text-center py-12">
                    <i className="fas fa-file-alt text-slate-300 text-4xl mb-3"></i>
                    <h3 className="text-sm font-bold text-slate-800 mb-1">No Applications Yet</h3>
                    ...
                    <Link
                      to="/jobs"
                      className="inline-flex items-center px-4 py-2 bg-slate-900 hover:bg-black text-white text-xs font-bold rounded-xl shadow-sm transition duration-200 group"
                    >
                      <i className="fas fa-briefcase mr-1.5 text-[10px]"></i> Browse Jobs
                    </Link>
                  </div>
                )}
              </div>
