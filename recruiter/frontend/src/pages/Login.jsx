      ...
      <div className="hidden lg:flex flex-col justify-between bg-slate-950 text-white p-16 relative overflow-hidden">
        ...
        <div className="my-auto max-w-md space-y-8 relative z-10">
          <h1 className="text-4xl font-black leading-tight tracking-tight text-white">
            Scale your hiring with <span className="text-blue-500">EmployVerse</span>.
          </h1>
          <p className="text-slate-400 text-base leading-relaxed">
            Log in to post job and internship listings, view applicants, manage hiring workflows, and find the perfect match for your team.
          </p>
          <ul className="space-y-4">
            <li className="flex items-center gap-3 text-sm font-semibold text-slate-300">
              ...
              Publish roles to a vast candidate pool
            </li>
            <li className="flex items-center gap-3 text-sm font-semibold text-slate-300">
              <span className="w-6 h-6 rounded-lg bg-blue-500/10 text-blue-500 flex items-center justify-center shrink-0">✓</span>
              Filter applicants using smart matching tools
            </li>
            <li className="flex items-center gap-3 text-sm font-semibold text-slate-300">
              <span className="w-6 h-6 rounded-lg bg-blue-500/10 text-blue-500 flex items-center justify-center shrink-0">✓</span>
              Manage applications and hire in one simple place
            </li>
          </ul>
        </div>
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full rounded-xl border border-slate-200 py-2.5 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 text-slate-800 placeholder:text-slate-400 bg-slate-50 text-sm transition-all duration-200"
                  />
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="000000"
                    className="w-full rounded-xl border border-slate-200 py-2.5 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 text-slate-800 text-center text-xl tracking-widest font-bold bg-slate-50 transition-all duration-200"
                  />
                </div>
